...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 128')
plt.savefig("N=128.png")
np.savetxt("N=128.csv", finalr, delimiter=",")
np.savetxt("W_for_N=128.csv", W, delimiter=",")
plt.show()
