...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 1024')
plt.savefig("N=1024.png")
np.savetxt("N=1024.csv", finalr, delimiter=",")
np.savetxt("W_for_N=1024.csv", W, delimiter=",")
#plt.show()
