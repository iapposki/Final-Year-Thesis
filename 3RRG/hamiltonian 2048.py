...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 2048')
plt.savefig("N=2048.png")
np.savetxt("N=2048.csv", finalr, delimiter=",")
np.savetxt("W_for_N=2048.csv", W, delimiter=",")
#plt.show()
