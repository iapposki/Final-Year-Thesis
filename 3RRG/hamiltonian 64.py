...
W = np.linspace(0,25,int(20/delta))
...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 64')
plt.savefig("N=64.png")
np.savetxt("N=64.csv", finalr, delimiter=",")
np.savetxt("W_for_N=64.csv", W, delimiter=",")
plt.show()
