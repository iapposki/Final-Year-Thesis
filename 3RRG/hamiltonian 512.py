...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 512')
plt.savefig("N=512.png")
np.savetxt("N=512.csv", finalr, delimiter=",")
np.savetxt("W_for_N=512.csv", W, delimiter=",")
plt.show()
