...
plt.xlabel('W')
plt.ylabel('r')
plt.title(' Mean adjacent gap ratio \'r\' as a function of disorder \'W\' at N = 4096')
plt.savefig("N=4096.png")
np.savetxt("N=4096.csv", finalr, delimiter=",")
np.savetxt("W_for_N=4096.csv", W, delimiter=",")
#plt.show()
